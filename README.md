# ALIVE Player (Android TV)

This repository contains the Android TV player implementation blueprint and scaffolding for an enterprise-grade digital signage player. It focuses on resilient playback, offline-first plan execution, and proof-of-play reporting.
...
- `PLAYER_IMPLEMENTATION_BLUEPRINT.md` for the full blueprint text.
- `README-FOLDER-STRUCTURE.md` for repo layout.
- `README-API-DB-TESTS.md` for API, DB, and acceptance tests.
