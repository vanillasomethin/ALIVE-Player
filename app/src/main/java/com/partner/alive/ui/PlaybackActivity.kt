...
import com.partner.alive.BuildConfig
...
import com.partner.alive.settings.SettingsActivity
import com.partner.alive.worker.InAppUpdateHelper
...
class PlaybackActivity : Activity() {
    ...
    private var engine: com.partner.alive.playback.PlaybackEngine? = null
